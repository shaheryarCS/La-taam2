...
class ReceivedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ReceivedPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class ReceivedPage extends StatefulWidget {
  ReceivedPage({Key key, this.title}) : super(key: key);

  final String title;
  final List<String> nameList=List();
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              "Your order has successfully recieved",
            ),
